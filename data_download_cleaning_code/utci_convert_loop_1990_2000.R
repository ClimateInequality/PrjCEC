...
setwd(
  "C:/Users/Kaifs/OneDrive/Documents/dropbox_penn/Dropbox/PIRE_bigdata_prc/kai_feng/utci_china_1982_2020"
)

dataFiles1990_01 <-
  lapply(
    Sys.glob(
      "1990_01_utci/c7c48ef9-5619-4759-a51b-598464e83e88-ECMWF_utci_*.nc"
    ),
    nc_open
  )
dataFiles1990_02 <-
  lapply(
    Sys.glob(
      "1990_02_utci/97dd92f8-0aa2-4db9-8ed1-b8a646ed8336-ECMWF_utci_*.nc"
    ),
    nc_open
  )
dataFiles1990_03 <-
  lapply(
    Sys.glob(
      "1990_03_utci/d42a8857-48b8-4517-a376-2bc67ce2b256-ECMWF_utci_*.nc"
    ),
    nc_open
  )
dataFiles1990_04 <-
  lapply(
    Sys.glob(
      "1990_04_utci/5bc72e54-c6d6-4b6b-a25c-69452b3db85b-ECMWF_utci_*.nc"
    ),
    nc_open
  )
dataFiles1990_05 <-
  lapply(
    Sys.glob(
      "1990_05_utci/0b7b71d4-605f-48e0-bd1e-b8ff4878cc52-ECMWF_utci_*.nc"
    ),
    nc_open
  )
dataFiles1990_06 <-
  lapply(
    Sys.glob(
      "1990_06_utci/d62da7b3-4a23-45c3-844f-ca9431e10a23-ECMWF_utci_*.nc"
    ),
    nc_open
  )
dataFiles1990_07 <-
  lapply(
    Sys.glob(
      "1990_07_utci/b9006cbe-5d27-424c-8de6-7c83bab3a88e-ECMWF_utci_*.nc"
    ),
    nc_open
  )
dataFiles1990_08 <-
  lapply(
    Sys.glob(
      "1990_08_utci/b2f44641-fc26-4831-87d0-20573da852a2-ECMWF_utci_*.nc"
    ),
    nc_open
  )
dataFiles1990_09 <-
  lapply(
    Sys.glob(
      "1990_09_utci/67651da4-3109-4e28-b13d-889c0f8205dc-ECMWF_utci_*.nc"
    ),
    nc_open
  )
dataFiles1990_10 <-
  lapply(
    Sys.glob(
      "1990_10_utci/6a2943ad-78ee-483c-9bb5-f4524217422c-ECMWF_utci_*.nc"
    ),
    nc_open
  )
dataFiles1990_11 <-
  lapply(
    Sys.glob(
      "1990_11_utci/6e7e9f95-f7a8-402f-ac84-64b9f5ed9d7a-ECMWF_utci_*.nc"
    ),
    nc_open
  )
dataFiles1990_12 <-
  lapply(
    Sys.glob(
      "1990_12_utci/d0d7312c-b37a-4745-84a6-beed9eb8677f-ECMWF_utci_*.nc"
    ),
    nc_open
  )
dataFiles2000_01 <-
  lapply(
    Sys.glob(
      "2000_01_utci/ea7625ba-ab7e-4982-b461-6cc8dd828e6b-ECMWF_utci_*.nc"
    ),
    nc_open
  )
dataFiles2000_02 <-
  lapply(
    Sys.glob(
      "2000_02_utci/42daa955-4ef8-4a42-b8b4-454f6ad9771d-ECMWF_utci_*.nc"
    ),
    nc_open
  )
dataFiles2000_03 <-
  lapply(
    Sys.glob(
      "2000_03_utci/bc8c80cc-0d9a-45cf-8058-889f46c54bd9-ECMWF_utci_*.nc"
    ),
    nc_open
  )
dataFiles2000_04 <-
  lapply(
    Sys.glob(
      "2000_04_utci/0dd7c55d-37d3-40da-9c17-73cd3f3257f4-ECMWF_utci_*.nc"
    ),
    nc_open
  )
dataFiles2000_05 <-
  lapply(
    Sys.glob(
      "2000_05_utci/c6295349-265c-4b58-8aa6-cd340978c232-ECMWF_utci_*.nc"
    ),
    nc_open
  )
dataFiles2000_06 <-
  lapply(
    Sys.glob(
      "2000_06_utci/d8b38106-7ca6-49d3-896e-1e6be674234a-ECMWF_utci_*.nc"
    ),
    nc_open
  )
dataFiles2000_07 <-
  lapply(
    Sys.glob(
      "2000_07_utci/01fbd388-60cc-46fa-ade9-937a4d0b67a3-ECMWF_utci_*.nc"
    ),
    nc_open
  )
dataFiles2000_08 <-
  lapply(
    Sys.glob(
      "2000_08_utci/d351f3ec-b44a-4530-a3d9-6eb6d49ff416-ECMWF_utci_*.nc"
    ),
    nc_open
  )
dataFiles2000_09 <-
  lapply(
    Sys.glob(
      "2000_09_utci/0a6f60ff-d576-405a-b6ef-d6f6007b13dd-ECMWF_utci_*.nc"
    ),
    nc_open
  )
dataFiles2000_10 <-
  lapply(
    Sys.glob(
      "2000_10_utci/0f03316c-4e6e-4bdc-a8af-38995abd8845-ECMWF_utci_*.nc"
    ),
    nc_open
  )
dataFiles2000_11 <-
  lapply(
    Sys.glob(
      "2000_11_utci/5a62c4e6-8b45-4b9f-906a-e2d668b7319e-ECMWF_utci_*.nc"
    ),
    nc_open
  )
dataFiles2000_12 <-
  lapply(
    Sys.glob(
      "2000_12_utci/da59b4a9-8ab7-4425-9e34-0d68e5748cae-ECMWF_utci_*.nc"
    ),
    nc_open
  )
#
