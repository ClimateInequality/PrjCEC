# Derived from `cec_code/code_d_regional/ffp_cec_inequality_run_demo_loc_a2_parallel_region_2020.R`
...
spt_path_out <- file.path(spt_pire_team_kf,
  "ineq_results", "ineq_demo_loc_par", "region_2020",
...
snm_out_file_name_prefix_base <- "dmloc_20region"
