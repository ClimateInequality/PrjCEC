...
str_prefix_loc <- ""
# stv_key_loc correspond to locations in the climate file
stv_key_loc <- "location_id"
# stv_key_loc_agg correspond to key in the demographic file
# and it is also the key in the for the *st_file_key_loc_agg* file.
# stv_key_loc_agg appears in the *st_file_key_loc* file as a variable.
