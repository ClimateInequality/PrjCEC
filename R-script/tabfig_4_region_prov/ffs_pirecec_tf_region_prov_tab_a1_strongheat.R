...
spn_path <- file.path(spt_path_res, "tab_a1_strongheat_data.csv", fsep = .Platform$file.sep)
df_data_tab_a1 <- read_csv(spn_path)
# latex file name for storage
spn_tex_out <- file.path(spt_path_res, "tab_a1_strongheat.tex", fsep = .Platform$file.sep)
...
for (st_kableformat in ar_st_kableformat) {
  ...
  bk_tab_a1 <- kbl(
    ...
    label = "app:regionprov:strongheat",
    # escape = F,
    linesep = "",
    booktabs = T,
    longtable = T,
