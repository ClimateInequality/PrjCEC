...
spt_path_out <- file.path(spt_pire_team_kf,
  "bookendYears", "ineq_results", "ineq_demo_par", "2019_2021_hour6t22",
  fsep = .Platform$file.sep
)

# 4. Data file names -----
st_file_demo <- "df_china_census_county_2020.csv"
st_file_envir <- "df_era5_utci_china_2019_2021_hour6t22.csv"
...
snm_out_file_name_prefix_base <- "dm_19t21h6t22"
