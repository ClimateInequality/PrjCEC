# 2026-03-10 12:56:50, restart because commented out `source("R-script/run_1c_mean_child_seasons/ffs_pirecec_nonwinter_bookends_convert.R")`
ar_it_results_set <- c(
    13,
    21,
    31, 32,
...
if (31 %in% ar_it_results_set) {
    source("R-script/run_3a_decompose/ffs_pirecec_demo_1990pop_2019t2021utci_par.R")
    source("R-script/run_3a_decompose/ffs_pirecec_demo_2020pop_1989t1991utci_par.R")
}
if (32 %in% ar_it_results_set) {
    source("R-script/run_3b_decompose_regional/ffs_pirecec_demo_loc_region_1990pop_2019t2021utci_par.R")
    source("R-script/run_3b_decompose_regional/ffs_pirecec_demo_loc_region_2020pop_1989t1991utci_par.R")
}
