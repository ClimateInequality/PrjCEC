# Implement step 2 of https://github.com/ClimateInequality/PrjCEC/issues/36
...
spn_path <- file.path(spt_path_res, "data_tab_a.csv", fsep = .Platform$file.sep)
...
ar_st_col_groups1 <- c(
  " " = 1,
  "All annual hours $\\ge$ UTCI thresholds" = 4,
  "Day time (6 am-10 pm) hours $\\ge$ UTCI thresholds" = 4
)
ar_st_col_groups2 <- c(
  " " = 1,
  "Share of time" = 2,
