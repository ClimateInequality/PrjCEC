...
spn_path <- file.path(spt_path_res, "data_tab_a2.csv", fsep = .Platform$file.sep)
df_data_tab_a2 <- read_csv(spn_path)
# latex file name for storage
spn_tex_out <- file.path(spt_path_res, "data_tab_a2.tex", fsep = .Platform$file.sep)
