...
spn_path <- file.path(spt_path_res, "tab_a_national_data.csv", fsep = .Platform$file.sep)
df_data_tab_a <- read_csv(spn_path)
# latex file name for storage
spn_tex_out <- file.path(spt_path_res, "tab_a_national.tex", fsep = .Platform$file.sep)
...
for (st_kableformat in ar_st_kableformat) {
  ...
  bk_tab_a <- kbl(
    ...
    longtable = T,
    align = "c",
    caption = "Decompose changes in average heat exposure for Chinese children (ages 0--14)",
